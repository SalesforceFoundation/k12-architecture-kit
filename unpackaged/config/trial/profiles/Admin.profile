...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        ...
        <recordType>hed__Behavior_Response__c.%%%NAMESPACED_ORG%%%Incident_Response</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>hed__Behavior_Response__c-%%%NAMESPACE%%%K12 Kit Positive Behavior Response Layout</layout>
        <recordType>hed__Behavior_Response__c.%%%NAMESPACED_ORG%%%Positive_Behavior_Response</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
     ...
     <layoutAssignments>
        <layout>hed__Behavior_Involvement__c-%%%NAMESPACE%%%K12 Kit Behavior Involvement Layout</layout>
        <recordType>hed__Behavior_Involvement__c.%%%NAMESPACED_ORG%%%Incident_Involvement</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>hed__Behavior_Involvement__c-%%%NAMESPACE%%%K12 Kit Positive Behavior Involvement Layout</layout>
        <recordType>hed__Behavior_Involvement__c.%%%NAMESPACED_ORG%%%Positive_Behavior_Involvement</recordType>
    </layoutAssignments>
