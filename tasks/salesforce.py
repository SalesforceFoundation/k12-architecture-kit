...
class UpdateAdminProfile(BaseUpdateAdminProfile):
    ...
    def _process_metadata(self):
        ...
        self._set_record_type("Account.Administrative".format(**namespace_args), "true")
        self._set_record_type(
            "Account.Academic_Program".format(**namespace_args), "false"
        )
        self._set_record_type(
            "Account.Business_Organization".format(**namespace_args), "false"
        )
        self._set_record_type(
        ...
        self._set_record_type(
            "Account.Sports_Organization".format(**namespace_args), "false"
        )
        self._set_record_type(
        ...
        self._set_record_type(
            "hed__Course_Enrollment__c.Default".format(**namespace_args), "false"
        )
        self._set_record_type(
            "hed__Course_Enrollment__c.Faculty".format(**namespace_args), "false"
        )
        self._set_record_type(
            "hed__Course_Enrollment__c.Student".format(**namespace_args), "true"
        )
