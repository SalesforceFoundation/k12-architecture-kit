...
class UpdateAdminProfile(BaseUpdateAdminProfile):
    ...
    def _process_metadata(self):
        ...
        self._set_record_type(
            "hed__Course_Enrollment__c.{namespaced_org}Default".format(
                **namespace_args
            ),
            "false",
        )
        self._set_record_type(
            "hed__Course_Enrollment__c.{namespaced_org}Faculty".format(
                **namespace_args
            ),
            "false",
        )
        self._set_record_type(
            "hed__Course_Enrollment__c.{namespaced_org}Student".format(
                **namespace_args
            ),
            "true",
        )
